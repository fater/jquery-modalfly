...
<div class="row">
    <div class="col-sm-7">
        ...
        <input type="checkbox" data-trigger="enter" data-name="multi_option[]" value="opt1" /> Multi option 1 <br />
        <input type="checkbox" data-trigger="enter" data-name="multi_option[]" value="opt2" /> Multi option 2 <br />
